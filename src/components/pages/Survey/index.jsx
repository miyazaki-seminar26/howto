    ...
    <div>
      ...
      <div className="md:mx-48">
        <Link href="/recommend/no-code">
          <div className="mb-2 flex cursor-pointer items-center justify-center font-semibold transition-all duration-300 hover:translate-x-1 hover:text-blue-600">
        ...
        <Link href="/recommend/other">
          <div className="flex cursor-pointer items-center justify-center font-semibold transition-all duration-300 hover:translate-x-1 hover:text-blue-600">
            <IconSquareArrowRight size={40} strokeWidth={1} color={'black'} />
